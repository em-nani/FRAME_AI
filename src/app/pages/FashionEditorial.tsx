...
export default function FashionEditorial() {
  ...
  const handleManualCreate = () => {
    // Create a blank project for manual setup
    const blankProject = {
      id: `project-${Date.now()}`,
      name: 'Untitled Fashion Project',
      prompt: 'Manual fashion & editorial project',
            ...
            >
              ...
              <section className="relative h-[60vh] flex items-center overflow-hidden mb-20">
                <div className="absolute inset-0">
                  <ImageWithFallback
                    src="https://images.unsplash.com/photo-1668952135061-2bd8d2638fda?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmYXNoaW9uJTIwcGhvdG9ncmFwaHklMjBlZGl0b3JpYWwlMjBtb2RlbCUyMHN0dWRpb3xlbnwxfHx8fDE3NzYwMTQxNDF8MA&ixlib=rb-4.1.0&q=80&w=1080"
            ...
            >
              ...
              <div className="mb-16">
                ...
                <p className="text-2xl text-slate-600 max-w-3xl">
                  AI will generate mood boards, call sheets, shot lists, and budgets
                </p>
              </div>

              <div className="mb-12">
                <Textarea
                  placeholder="A minimalist fashion editorial for Fall/Winter collection. Two models in urban setting, natural light. Focus on textures and layering. Need 25 final images for print magazine..."
                  value={prompt}
              ...
              <div className="flex items-center justify-between">
                <Button
                  variant="ghost"
                  onClick={() => setPrompt('A minimalist fashion editorial for Fall/Winter collection. 2 models in urban setting, natural light. Focus on textures and layering. Need 25 final images for print magazine.')}
                  disabled={isGenerating}
