...
export default function CommercialPhotography() {
  ...
  const handleManualCreate = () => {
    const blankProject = {
      id: `project-${Date.now()}`,
      name: 'Untitled Commercial Project',
      prompt: 'Manual commercial photography project',
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="mx-auto max-w-[1600px] px-8 py-6 flex items-center justify-between">
          ...
          <Link to="/">
            <Button variant="ghost" className="gap-2 hover:text-orange-600">
            ...
            >
              ...
              <section className="relative h-[60vh] flex items-center overflow-hidden mb-20">
                ...
                <div className="relative z-10 max-w-[1600px] mx-auto px-8 w-full">
                  ...
                  >
                    Product shoots, brand campaigns, lifestyle imagery
                  </motion.p>
                </div>
              </section>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  >
                    <div className="relative h-[500px] overflow-hidden mb-6 bg-black">
                      <motion.div whileHover={{ scale: 1.05 }} transition={{ duration: 0.4 }}>
                        <ImageWithFallback
                          src="https://images.unsplash.com/photo-1652200179065-8ef3eacd9815?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb21tZXJjaWFsJTIwcHJvZHVjdCUyMHBob3RvZ3JhcGh5JTIwbGlnaHRpbmclMjBzdHVkaW8lMjBwcm9mZXNzaW9uYWx8ZW58MXx8fHwxNzc2MDE0MTQyfDA&ixlib=rb-4.1.0&q=80&w=1080"
                          alt="AI Generation"
                    ...
                    <Button className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-6 rounded-full h-auto">
                      Use AI Generator
                    </Button>
                  </motion.div>
                  ...
                  >
                    <div className="relative h-[500px] overflow-hidden mb-6 bg-black">
                      <motion.div whileHover={{ scale: 1.05 }} transition={{ duration: 0.4 }}>
                        <ImageWithFallback
                          src="https://images.unsplash.com/photo-1584896201356-3b38308a6285?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwyfHxjb21tZXJjaWFsJTIwcHJvZHVjdCUyMHBob3RvZ3JhcGh5JTIwbGlnaHRpbmclMjBzdHVkaW8lMjBwcm9mZXNzaW9uYWx8ZW58MXx8fHwxNzc2MDE0MTQyfDA&ixlib=rb-4.1.0&q=80&w=1080"
                          alt="Manual Creation"
                          className="w-full h-full object-cover opacity-60 group-hover:opacity-80 transition-opacity duration-500"
                        />
                      </motion.div>
          ...
          {mode === 'ai' && (
            ...
            >
              <Button
                ...
                className="mb-12 hover:text-orange-600"
              >
              ...
              <div className="mb-16">
                ...
                <p className="text-2xl text-slate-600 max-w-3xl">
                  AI will generate shot lists, lighting setups, equipment needs, and budgets
                </p>
              </div>

              <div className="mb-12">
                <Textarea
                  placeholder="Product shoot for new sneaker line. Studio setup with clean white background. Need 50 product shots from multiple angles plus lifestyle images. Professional lighting with detail emphasis..."
                  value={prompt}
                  onChange={(e) => setPrompt(e.target.value)}
                  className="min-h-[240px] bg-white border-2 border-black/10 text-lg resize-none focus:border-orange-500 focus:ring-orange-500 p-6"
              ...
              <div className="flex items-center justify-between">
                <Button
                  variant="ghost"
                  onClick={() => setPrompt('Product shoot for new sneaker line. Studio setup with clean white background. Need 50 product shots from multiple angles plus lifestyle images. Professional lighting with detail emphasis.')}
                  disabled={isGenerating}
                ...
                <Button
                  ...
                  className="gap-2 bg-orange-500 hover:bg-orange-600 text-white px-12 py-7 rounded-full h-auto text-lg"
                >
                  {isGenerating ? (
                    <>
              ...
              {isGenerating && (
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="mt-12 p-8 bg-orange-50 border-2 border-orange-200"
                >
